...
#define LNK_BSS_BASE_OFFSET_IN_OBJ(datalen)  ( (void*)( (char *)0 + (long)datalen) + LNK_MAX_PLTGOT_LEN)
#define LNK_PLTGOT_BASE_OFFSET_IN_OBJ(datalen)  ( (void*)( (char *)0 + (long)datalen))
...
#pragma pack()
//#endif
#define LNK_ELF_PLTGOT_ADDRLONG_OFFSET ( (size_t)&(((struct linkable_elf_pltgot_item *)0)->addrlong) )
...
#define LNK_HOOK_FUNS_OFFSET_OF_HDR ( (size_t)((struct linkable_elf_rep_hdr*)0)->hookfuns )
#define LNK_HOOK_FUN_OFFSET_OF_STRU ( (size_t)((struct linkable_elf_hook_fun*)0)->origfunhead )
#define LNK_HOOK_FUN_JMPTAIL_OFFSET_OF_STRU ( (size_t)((struct linkable_elf_hook_fun*)0)->jmporigfuntail )
#define LNK_HOOK_FUN_ORIGFUNHEAD_ENTRY(rephdr,idx) ( rephdr + LNK_HOOK_FUNS_OFFSET_OF_HDR + (idx * LNK_HOOK_FUN_STRU_SIZE) + LNK_HOOK_FUN_OFFSET_OF_STRU )
#define LNK_HOOK_FUN_ORIGFUNTAIL_ENTRY(rephdr,idx) ( rephdr + LNK_HOOK_FUNS_OFFSET_OF_HDR + (idx * LNK_HOOK_FUN_STRU_SIZE) + LNK_HOOK_FUN_JMPTAIL_OFFSET_OF_STRU )
...
struct linkable_elf_internals * linkable_elf_obj_create(
	...
	void * base_rephdr_ptr, void * bssptr, long bsslen, 
	void * pltgotptr, long pltgotlen, const char *pat_symbol);
